...
--
-- Host: localhost    Database: challenge48h
-- ------------------------------------------------------
...
CREATE TABLE `quartiers` (
  `idQuartiers` int(11) NOT NULL AUTO_INCREMENT,
  `note_moy` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idQuartiers`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'eveab','eve.andrebrenner@ynov.com','ab4f63f9ac65152575886860dde480a1');
...
-- Dump completed on 2020-05-15  9:34:55
